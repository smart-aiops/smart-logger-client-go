...
type RawData struct {
	...
	Vendor   string `protobuf:"bytes,2,opt,name=vendor,proto3" json:"vendor,omitempty"`       //厂商
	Host     string `protobuf:"bytes,3,opt,name=host,proto3" json:"host,omitempty"`           //主机
	Port     int64  `protobuf:"varint,4,opt,name=port,proto3" json:"port,omitempty"`          //端口号
	ClientIp string `protobuf:"bytes,5,opt,name=clientIp,proto3" json:"clientIp,omitempty"`   //请求客户端的Ip
	ReqUrl   string `protobuf:"bytes,6,opt,name=reqUrl,proto3" json:"reqUrl,omitempty"`       //请求地址
	Headers  string `protobuf:"bytes,7,opt,name=headers,proto3" json:"headers,omitempty"`     //请求头部信息(可选择获取) 默认获取user-agent,content-type
	Tag      string `protobuf:"bytes,8,opt,name=tag,proto3" json:"tag,omitempty"`             //操作标签,默认值undefined
	Content  string `protobuf:"bytes,9,opt,name=content,proto3" json:"content,omitempty"`     //方法步骤内容,默认是空,可使用LogData.step进行内容步骤记录, 当前只支持java sdk
	Method   string `protobuf:"bytes,10,opt,name=method,proto3" json:"method,omitempty"`      //请求的本地方法
	Args     string `protobuf:"bytes,11,opt,name=args,proto3" json:"args,omitempty"`          //方法请求参数
	RespBody string `protobuf:"bytes,12,opt,name=respBody,proto3" json:"respBody,omitempty"`  //方法响应参数
	CostTime int64  `protobuf:"varint,13,opt,name=costTime,proto3" json:"costTime,omitempty"` //整个方法内部耗时
	LogDate  int64  `protobuf:"varint,14,opt,name=logDate,proto3" json:"logDate,omitempty"`   //Log产生时间,LogData对象初始化的时间
	Success  bool   `protobuf:"varint,15,opt,name=success,proto3" json:"success,omitempty"`   //执行状态,成功(true)/异常(false)
	Account  string `protobuf:"bytes,16,opt,name=account,proto3" json:"account,omitempty"`    //操作用户名
	Level    int64  `protobuf:"varint,17,opt,name=level,proto3" json:"level,omitempty"`       //日志级别 0 一般 1 低危 2 中危 3 高危
}
...
func (x *RawData) GetVendor() string {
	if x != nil {
		return x.Vendor
	}
	return ""
...
var file_grpc_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xa5, 0x03, 0x0a, 0x07, 0x52, 0x61, 0x77, 0x44, 0x61, 0x74, 0x61, 0x12,
	0x18, 0x0a, 0x07, 0x61, 0x70, 0x70, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x07, 0x61, 0x70, 0x70, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x76, 0x65, 0x6e,
	...
	,
